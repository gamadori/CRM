...
namespace CRM.Client.Services
{
    ...
    public class TicketsService: RestClientModelService<Ticket, TicketModel, TicketFilter, int>, ITicketService
    {
        
        public TicketsService(HttpClient http): base(http, ConstHelper.TicketPath)
        {
